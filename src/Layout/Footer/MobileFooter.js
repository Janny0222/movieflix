...
const MobileFooter = () => {
    ...
    console.log("result", mobileDrawer, toggleDrawer)
  return (
    <>
        ...
        <footer className='lg:hidden  fixed z-50 bottom-0 w-full px-1'>
            <div className='bg-dry rounded flex-btn w-full p-1'>
                <NavLink to="/movies" className={Hover}>
                    <BsCollectionPlay />
                </NavLink>
                <NavLink to="/favorites" className={Hover}>
                    <div className='relative'>
                        <div className='w-5 h-5 flex-colo rounded-full text-xs bg-subMain text-white absolute -top-4 -right-1'>
                            3
                        </div>
                        <FiHeart />
                    </div>
