                ...
                <video controls autoPlay={play} className='w-full h-full rounded'>
                    ...
                    <div className='w-full h-screen rounded-lg overflow-hidden relative'>
                        <div className='absolute top-0 left-0 right-0 bottom-0 bg-main bg-opacity-30 flex-colo'>
                            <button onClick={() => setPlay(true)} className='bg-white text-subMain flex-colo border-subMain hover:text-main transitions rounded-full w-20 h-20 font-medium text-xl'>
                                <FaPlay />
                            </button>
                        </div>
