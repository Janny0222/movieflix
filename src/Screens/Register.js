    ...
    <Layout>
        <div className='container mx-auto px-2 my-24 flex-colo'>
            <div className='w-full 2xl:w-2/5 gap-8 flex-colo sm:p-14 p-8 md:w-3/5 bg-dry rounded-lg border border-border'>
                ...
                <Input label="Email" placeholder="Enter your Email" type="email" bg={true} />
                ...
                <p className='text-center text-border'>
                  Already have an account?{" "} <Link to='/login' className='text-dryGray font-semibold ml-2'>Sign In</Link>
                </p>
            </div>
        </div>
    </Layout>
