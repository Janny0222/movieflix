        ...
        <div className='xl:col-span-2 flex flex-col gap-8'>
          ...
          <div className='col-span-3 flex flex-col gap-6'>
            ...
            <div className='w-full flex flex-col bg-main gap-6 rounded-lg md:p-12 p-6 h-header overflow-y-scroll'>
              {
                UserData.map((user, i) => (
                  <div className='md:grid flex flex-col w-full grid-cols-12 gap-6 bg-dry p-4 border-gray-800 rounded-lg'>
                      <div className='col-span-2 bg-main hidden md:block'>
                        <img src={`/images/users/${user? user.image : 'user.jpg'}`} alt={user.fullName} className='w-full h-24 rounded-lg object-cover' />
                      </div>
